    ...
    public class ProductDAO
    {
        ...
        public static void SaveProduct(Product p) 
        {
            try
            {
                ...
                context.Products.Add(p); // Add to Product collection context.SaveChanges(); // Update Database
            }
            catch (Exception e)
            {
        ...
        public static void UpdateProduct(Product p) 
        {
            try
            {
                ...
                = Microsoft.EntityFrameworkCore.EntityState.Modified; context.SaveChanges();
            }
            catch (Exception e)
            {
                throw new Exception(e.Message);
